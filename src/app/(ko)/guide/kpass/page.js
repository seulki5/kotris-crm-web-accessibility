				...
				<dl>
					...
					<dd>
						...
						<div>
							...
							<div className={'detail'}>
								<h3 className={'title'}>K-패스 회원가입</h3>
						...
						<div>
							...
							<div className={'detail'}>
								<h3 className={'title'}>모바일 Rail+로 전국 대중교통 이용</h3>
							</div>
						</div>
					</dd>
				</dl>
							...
							<ul>
								<li>
									...
									>
										...
										<tbody>
											<tr>
												<td scope='col' className={'col-span-1'}>적립률</td>
												<td scope='col' className={'col-span-1'}>20%</td>
												<td scope='col' className={'col-span-1'}>30%</td>
												<td scope='col' className={'col-span-1'}>53%</td>
												<td scope='col' className={'col-span-1'}>30%</td>
												<td scope='col' className={'col-span-1'}>50%</td>
											</tr>
										</tbody>
										<tfoot></tfoot>
									</table>
				...
				<dl>
					...
					<dd>
						<div className={'center-wrap'}>
							<a href={'tel:0314274415'}>
								<span>K-패스 고객센터</span>
								<span className={'text-dynamic-text-brand-primary font-semibold'}>
									031-427-4415
								</span>
							</a>
							<a href={'tel:15887788'}>
								<span>레일플러스 고객센터</span>
								<span className={'text-dynamic-text-brand-primary font-semibold'}>
									1588-7788
								</span>
							</a>
					...
					<dl>
						...
						<dd>
							<div className={'center-wrap'}>
								<a href={'tel:0314274415'}>
									<span>K-패스 고객센터</span>
									<span className={'text-body-xl text-dynamic-text-brand-primary font-semibold'}>
										031-427-4415
									</span>
								</a>
								<a href={'tel:15887788'}>
