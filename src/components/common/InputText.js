...
const InputText = forwardRef(({
    ...
    const stylesBySize = {
        sm: {
            ...
            paddingWithIcon: 'pl-6 pr-49',
            paddingWithoutIcon: 'pl-6 pr-28',
            iconSize: 16,
        },
        md: {
            wrapper: 'h-[48px]',
            textSize: 'text-body-md',
            paddingWithIcon: 'pl-10 pr-62',
            paddingWithoutIcon: 'pl-10 pr-35',
            iconSize: 20,
        },
        lg: {
            wrapper: 'h-[56px]',
            textSize: 'text-body-xl',
            paddingWithIcon: 'pl-14 pr-74',
            paddingWithoutIcon: 'pl-14 pr-44',
            iconSize: 24,
        },
    };
