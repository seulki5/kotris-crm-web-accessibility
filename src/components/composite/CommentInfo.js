								...
								<div className={'flex flex-row'} aria-hidden={true}>
									...
									</p>
									{
										li.composite ? (
											...
											<p className={`text-body-xl font-medium ml-3 ${li.textColor} whitespace-pre-wrap mo:text-body-sm mo:font-normal`} aria-hidden={true}>
												{li.message}
											</p>
										)
									}
