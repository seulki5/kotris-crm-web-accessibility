		...
		<main id={'support'} className={'body-wrap-832 contact-wrap'} aria-labelledby={'page-name-dt'}>
			...
			<div className={'mt-56 flex-col-center gap-72'}>
				<div className={'call-wrap'}>
					<div>
						<p>전화상담</p>
						<p><a href={'tel:15887788'}>1588-7788</a></p>
				...
				<dl>
					<div className={'flex-row-center'}>
						...
						<dd>
							...
							<button
								type={'button'}
								aria-label={'한국철도 고객의 소리 사이트 이동하기'}
					...
					<div className={'flex-row-center'}>
						<dt>제휴 문의</dt>
						<dd>
							<p>여러분의 사업에 신속하고 정확한 Rail+ 결제시스템이 필요하시다면 회사소개서나 제안서를 첨부하여 아래 담당자에게 메일을 보내주십시오. 담당자가 면밀히 검토 후 바로 연락 드리도록 하겠습니다.</p>
							<p>Rail+ 결제시스템은 언제나 혁신적인 여러분들의 사업번영을 위해 안전하고 믿음직한 비즈니스 파트너로서 지원을 아끼지 않겠습니다.</p>
							<p className={'text-dynamic-text-neutral-primary'}>
								이메일 문의 :{' '}
								<a href='mailto:smart@korail.com' className='text-blue-600 underline ml-2'>
									smart@korail.com
								</a>
							</p>
						</dd>
				...
				<dl>
					...
					<div className={'flex-col-center'}>
						...
						<dd>
							...
							<p className={'text-dynamic-text-neutral-primary'}>
								이메일 문의 :{' '}
								<a href='mailto:smart@korail.com'>
									smart@korail.com
								</a>
							</p>
						</dd>
