	...
	return (
		<main id={'guide'} className={'body-wrap-880'} aria-labelledby={'page-name-dt'}>
			...
			<section className={'type08'}>
				<dl>
					<dt>
						<h3 className={'sr-only'}>서비스 이용 방법</h3>
						<h3 aria-hidden={true}>서비스<br/>이용 방법</h3>
					</dt>
					<dd>
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>Rail+ 회원가입 <span className={'flex-row-center gap-6'}><BdgGuardian/><BdgChildren/></span></h5>
						...
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>Rail+ 카드 등록 <BdgChildren/></h5>
						...
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>어린이 안심서비스 신청 <BdgGuardian/></h5>
						...
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>신청 접수 처리</h5>
				...
				<dl>
					...
					<dd>
						<div>
							...
							<p className={'decimal'} aria-label={'첫번째'}>1</p>
							<div className={'detail'}>
								<h5 className={'title'}>Rail+ 회원가입 <span className={'flex-row-center gap-2'}><BdgGuardian/><BdgChildren/></span></h5>
								<p>보호자, 자녀 모두 레일플러스에 회원가입</p>
							</div>
						</div>
						<div>
