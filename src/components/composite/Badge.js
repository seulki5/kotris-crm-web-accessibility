...
export default function Badge({
    ...
    return (
        <div className={clsx('w-fit h-fit min-h-[29px] rounded-6 px-8 py-4 flex-col-center-center', badgeInfo.bgColor)}>
            <p
                className={"text-body-md text-dynamic-text-neutral-inverse font-semibold leading-snug whitespace-nowrap mo:leading-none"}
                aria-label={`권종: ${badgeInfo.name} ${fncGetPaymentName()}`}
            >
