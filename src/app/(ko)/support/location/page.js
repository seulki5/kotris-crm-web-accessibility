					...
					<div>
						...
						<dd className={'flex-row-center'}>
							<span className={'sr-only'}>
								1호선, 4호선 서울역 하차, 1번 출구
							</span>
							<span className={'subway-line bg-[#0B7EFE]'} aria-hidden={true}>1</span>
							<span className={'subway-line bg-[#00C4FF]'} aria-hidden={true}>4</span>
							<span className={'ml-8'} aria-hidden={true}>서울역 하차, 1번 출구</span>
						</dd>
					</div>
					<div>
						<dt>
						...
						<dd className={'flex flex-col gap-12'}>
							<div className={'flex-row-center'}>
								<span className={'sr-only'}>
									지선: 7011, 7017, 7019, 7021, 7022, 8000
								</span>
								<span className={'bus-line text-dynamic-text-other-lime border-dynamic-border-other-lime'} aria-hidden={true}>지선</span>
								<span aria-hidden={true}>7011, 7017, 7019, 7021, 7022, 8000</span>
							</div>
							<div className={'flex-row-center'}>
								<span className={'sr-only'}>
									간선: 103, 163, 202, 405, 500, 702A, 505, 506
								</span>
								<span className={'bus-line text-dynamic-text-other-blue border-dynamic-border-other-blue'} aria-hidden={true}>간선</span>
								<span aria-hidden={true}>103, 163, 202, 405, 500, 702A, 505, 506</span>
							</div>
							<div className={'flex-row-center'}>
								<span className={'sr-only'}>
									직행: 9401, 9703, 9706, 9709, 9710, 9713, 9714
								</span>
								<span className={'bus-line text-dynamic-text-other-red border-dynamic-border-other-red'} aria-hidden={true}>직행</span>
								<span aria-hidden={true}>9401, 9703, 9706, 9709, 9710, 9713, 9714</span>
							</div>
						</dd>
					</div>
				</dl>
				...
				<dl>
					...
					<div>
						...
						<dd className={'flex-row-center'}>
							...
							<span className={'subway-line bg-[#0B7EFE]'} aria-hidden={true}>1</span>
							<span className={'subway-line bg-[#00C4FF]'} aria-hidden={true}>4</span>
							<span className={'ml-6'} aria-hidden={true}>서울역 하차, 1번 출구</span>
						</dd>
					</div>
					<div>
						<dt>
