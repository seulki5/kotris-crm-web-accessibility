					...
					<dl>
						...
						<dd>
							<div className={'relative'}>
								<p className={'title'}>온라인</p>
								<table summary={'온라인 환불 및 수수료 안내 표입니다.'}>
									<caption className='sr-only'>온라인 환불 안내 표</caption>
									<tbody>
										<tr>
											<th scope='col'>환불처</th>
							...
							<div className={'relative'}>
								<p className={'title'}>오프라인</p>
								<table summary={'오프라인 환불 및 수수료 안내 표입니다.'}>
									<caption className='sr-only'>오프라인 환불 안내 표</caption>
									<tbody>
										<tr>
											<th scope='col'>환불처</th>
											<td className={'col-span-1'}>
												...
												<ul className={'pl-5'} style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>간선 철도역</li>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>광역 철도역</li>
												</ul>
											</td>
											<td className={'col-span-1'}>
												<p className={'font-semibold'}>편의점</p>
												<ul className={'pl-5'} style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>emart 24</li>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>CU</li>
												</ul>
											</td>
											<td className={'col-span-1'} style={{justifyContent: 'flex-start'}}>
												<p className={'font-semibold'}>ATM</p>
												<ul className={'pl-5'} style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>우리은행</li>
												</ul>
											</td>
										</tr>
										<tr>
											<th scope='col'>환불금액기준<br/>(소요시간)</th>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>철도역: 20만원 이하(즉시반환)</span>
												<span aria-hidden={true}>20만원 이하 (즉시반환)</span>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>편의점: 3만원 이하 (즉시 반환)</span>
												<span aria-hidden={true}>3만원 이하 (즉시 반환)</span>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>ATM: 20만원 이하 (즉시 반환)</span>
												<span aria-hidden={true}>20만원 이하 (즉시 반환)</span>
											</td>
										</tr>
										<tr>
											<th scope='col'>환불수수료</th>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>철도역: 500원</span>
												<span aria-hidden={true}>500원</span>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>편의점: 500원</span>
												<span aria-hidden={true}>500원</span>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>ATM: 500원</span>
												<span aria-hidden={true}>500원</span>
											</td>
										</tr>
										<tr>
											<th scope='col'>환불방법</th>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>철도역</span>
												<ul className={'pl-5'} style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>매표창구(WTIM)<br/>단말기 환불</li>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>휴대 정산기 환불</li>
												</ul>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>편의점</span>
												<ul className={'pl-5'} style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>결제 단말기 환불</li>
												</ul>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>ATM</span>
												<ul className={'pl-5'} style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>ATM 단말기 환불<br/>(우리은행 계좌 보유고객 限)</li>
												</ul>
											</td>
										</tr>
										<tr>
											<th scope='col'>1일 최대<br/>환불 금액</th>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>철도역: 20만원</span>
												<span aria-hidden={true}>20만원</span>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>편의점: 5만원</span>
												<span aria-hidden={true}>5만원</span>
											</td>
											<td className={'col-span-1'}>
												<span className={'sr-only'}>ATM: 20만원</span>
												<span aria-hidden={true}>20만원</span>
											</td>
										</tr>
									</tbody>
							...
							<ul className={'comment'} aria-label={'오프라인 환불 캡션'}>
					...
					<dl style={{padding: 0}}>
						...
						<dd>
							<div className={'relative'}>
								<p className={'title'}>온라인</p>
								<table summary={'온라인 환불 및 수수료 안내 표입니다.'}>
									<caption className='sr-only'>온라인 환불 및 수수료 안내 표</caption>
									<thead>
										<tr>
									...
									<tbody>
										<tr>
											...
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8}}>
												...
												<ul style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal break-keep before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>간선 철도역</li>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal break-keep before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>광역 철도역</li>
												</ul>
											</td>
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8}}>
												<p className={'font-semibold'}>편의점</p>
												<ul style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal break-keep before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>emart 24</li>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal break-keep before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>CU</li>
												</ul>
											</td>
											<td className={'col-span-1'} style={{justifyContent: 'flex-start', paddingLeft: 8, paddingRight: 8}}>
												...
												<ul style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal break-keep before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>우리은행</li>
												</ul>
											</td>
										</tr>
										<tr>
											<th scope='col' style={{paddingLeft: 1, paddingRight: 1}}>환불금액기준<br/>(소요시간)</th>
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8}}>
												<p className={'break-keep'} aria-label={'철도역: 20만원 이하(즉시반환)'}>20만원 이하 (즉시 반환)</p>
											</td>
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8}}>
												<p className={'break-keep'} aria-label={'편의점: 3만원 이하 (즉시 반환)'}>3만원 이하 (즉시 반환)</p>
											</td>
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8}}>
												<p className={'break-keep'} aria-label={'에이티엠: 20만원 이하 (즉시 반환)'}>20만원 이하 (즉시 반환)</p>
											</td>
										</tr>
										<tr>
											<th scope='col' style={{paddingLeft: 4, paddingRight: 4}}>환불수수료</th>
										...
										<tr>
											...
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8}}>
												<span className={'sr-only'}>ATM</span>
												<ul style={{listStyleType: 'none'}}>
													<li className={`text-body-md text-dynamic-text-neutral-tertiary font-normal before:content-['-'] before:mr-3 before:text-dynamic-text-neutral-tertiary`}>ATM 단말기 환불 (우리은행 계좌 보유고객 限)</li>
												</ul>
											</td>
										</tr>
										<tr>
											<th scope='col' style={{paddingLeft: 4, paddingRight: 4}}>1일 최대<br/>환불 금액</th>
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8, justifyContent: 'center'}}>
												<span className={'sr-only'}>철도역: 20만원</span>
												<span aria-hidden={true}>20만원</span>
											</td>
											<td className={'col-span-1'} style={{paddingLeft: 8, paddingRight: 8, justifyContent: 'center'}}>
