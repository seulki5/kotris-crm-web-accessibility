    ...
    return (
        ...
        >
            <div className={'popup-bg-opacity'}>
                <div className={`${sizesByScreen[screen].width} ${sizesByScreen[screen].padding} popup-float-wrap`}>
                    <div className={'min-h-[54px] mb-24 flex flex-col justify-center'}>
                        <p className={'text-body-2xl text-dynamic-text-neutral-primary font-medium whitespace-pre-line'} id={'popup-title'}>
                            {mainText}
                        </p>
                        <div className={`
