					...
					<dd>
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>카드 잔액 충전</h5>
						...
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>레일플러스 사용</h5>
							</div>
						</div>
						<div>
							<p className={'decimal'} aria-label={'세번째'}>3</p>
							<div className={'detail'}>
								<h5 className={'title'}>충전 금액 잔액 내 사용</h5>
							</div>
						</div>
					</dd>
				</dl>
							...
							<div className={'billing'}><Image src={PrepaidImage02} alt={'Step2: 선불형 서비스 전환 안내'}/></div>
							{
								isMobile ? (
									<div className={'billing relative'}>
										<Image src={PrepaidImage03} alt={'Step3: 선불형 카드 전환 완료'} aria-hidden={true} />
										<div className={'guide-bottom-comment'}>
											<p aria-label={'Step3: 선불형 카드 전환 완료. 선불형 카드가 없을 경우 신규발급이 필요합니다.'}>
												선불형 카드가 없을 경우 신규발급이 필요합니다.
											</p>
										</div>
									</div>
								) : (
