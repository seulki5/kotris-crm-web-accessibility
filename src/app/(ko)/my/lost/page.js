...
import CardLostStep1 from '@/app/(ko)/my/lost/components/CardLostStep1';
import CardLostStep2 from '@/app/(ko)/my/lost/components/CardLostStep2';
 ...
 */
export default function MyCardLost() {
