...
export default function CertStep1({data, fncCallbackEvent}) {
 ...
 * @screenID:    -
 */
DtCertStep1.propTypes = {
	data: PropTypes.object,
	fncCallbackEvent: PropTypes.func,
	fncSetIsAll: PropTypes.func
};

export function DtCertStep1({data, fncCallbackEvent, fncSetIsAll}) {
 ...
 * @screenID:    -
 */
MoCertStep1.propTypes = {
	data: PropTypes.object,
	fncCallbackEvent: PropTypes.func,
	fncSetIsAll: PropTypes.func
};

export function MoCertStep1({data, fncCallbackEvent, fncSetIsAll}) {
				...
				<div>
					<div className={'checkbox-wrap border'}>
						...
						<button
							...
							onKeyDown={(e) => {
								if (e.key === 'Enter') fncShowTermsPop('termUse');
							}}>
							보기
						</button>
					</div>
					<div className={'checkbox-wrap border'}>
						...
						<button
							...
							onKeyDown={(e) => {
								if (e.key === 'Enter') fncShowTermsPop('termReqrdPii');
							}}>
							보기
						</button>
					</div>
					<div className={'relative'}>
						<button className={'checkbox-wrap accordion-header-wrap'}>
							<Checkbox
								type={'brand'}
							...
							/>
							<div
								className={`transform transition-transform duration-300 ${openAccordion ? 'rotate-180' : ''}`}
								onClick={() => setOpenAccordion(!openAccordion)}
								onKeyDown={(e) => {
									if (e.key === 'Enter' || e.key === '') setOpenAccordion(!openAccordion);
								}}
							>
								<ChevronDown
									width={20} height={20}
									...
									<div className={'w-full'}>
										<div className={'sub-checkbox-wrap'}>
											...
											<button
												...
												onKeyDown={(e) => {
													if (e.key === 'Enter') fncShowTermsPop('termSvcNoti');
												}}>
												보기
											</button>
										</div>
							...
							<div className={'w-full'}>
								<div className={'sub-checkbox-wrap'}>
									...
									<button
										...
										onKeyDown={(e) => {
											if (e.key === 'Enter') fncShowTermsPop('termAdOption');
										}}>
										보기
									</button>
								</div>
							...
							<div className={'w-full'}>
								<div className={'sub-checkbox-wrap'}>
									...
									<button
										...
										onKeyDown={(e) => {
											if (e.key === 'Enter') fncShowTermsPop('termMktPii');
										}}>
										보기
									</button>
								</div>
