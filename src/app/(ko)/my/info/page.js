	...
	return (
		<main id={'my'} className={'body-wrap-618'} aria-labelledby={'page-name-dt'}>
			...
			<div className={'grid gap-48'}>
				<fieldset role={'group'} aria-label={'사용자 기본 정보'} className={'info-wrap'}>
					<dl>
						...
						<div className={'flex-row-center'}>
							<dt>생년월일</dt>
							<dd>{data.userInfo?.custBrdt ? moment(data.userInfo?.custBrdt).format('YYYY.MM.DD') : '-'}</dd>
						</div>
						<div className={'flex-row-center'}>
							<dt>휴대폰 번호<span className={'essential'}>*</span></dt>
						...
						<div className={'flex-col-center'}>
							<div className={'flex-row-center'}>
								<dt>현재 비밀번호<span className={'essential'}>*</span></dt>
								<dd>
									<InputText
										size={'sm'}
										fitWidth={true}
				...
				<fieldset role={'group'} aria-label={'마케팅 및 광고 알림 설정'} className={'marketing-wrap mt-40'}>
					<div className={'group-header'}>
						<h2>마케팅 및 광고 알림 설정</h2>
						<div className={'divider'}/>
					</div>
					<div className={'group-body flex-row'}>
						<p className={'text-body-xl'}>[선택] 광고성 정보 수신 동의</p>
						<div className={'flex-row-center gap-8 status'} role={'none'}>
				...
				<fieldset role={'group'} aria-label={'할인 정보'} className={'discount-wrap grid gap-12'}>
					<div className={'group-header'}>
						<h2>할인 정보</h2>
						<div className={'divider'} />
					</div>
							...
							<div className={'flex-row-center'}>
								...
								<dd>
									<InputText
										size={'sm'}
										fitWidth={true}
										placeholder={'영문 + 숫자 + 특수문자 9~20자리 입력'}
										inputType={'password'}
										keypad={'password'}
										allows={['alnum', 'pwChar']}
										minLength={9}
