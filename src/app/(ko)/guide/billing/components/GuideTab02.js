					...
					<dd>
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>레일플러스 앱 다운로드 및 실행</h5>
						...
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>후불형 카드 등록 및 사용</h5>
						...
						<div>
							...
							<div className={'detail'}>
								<h5 className={'title'}>사용대금 후불 청구</h5>
							...
							<div className={'billing'}><Image src={PostpaidImage02} alt={'Step2: 후불형 서비스 전환 안내'}/></div>
							{
								isMobile ? (
									<div className={'billing relative'}>
										<Image src={PostpaidImage03} alt={'Step3: 후불형 카드 전환 완료'} aria-hidden={true}/>
										<div className={'guide-bottom-comment'}>
											<p aria-label={'Step3: 후불형 카드 전환 완료. 후불형 카드가 없을 경우 신규발급이 필요합니다.'}>
												후불형 카드가 없을 경우 신규발급이 필요합니다.
											</p>
										</div>
									</div>
								) : (
