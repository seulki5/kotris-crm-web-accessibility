 ...
 */
DiscountMinorsRegisterStep1.propTypes = {
	data: PropTypes.object,
	fncCallbackEvent: PropTypes.func
};
export default function DiscountMinorsRegisterStep1({data, fncCallbackEvent}) {
		...
		<>
			...
			<div className={'flex flex-col gap-30 page-bottom-space'}>
				...
				<div className={'checkbox-wrap'}>
					...
					<button
						className={'terms'}
						onClick={() => fncShowTermsPop('termPii')}
						onKeyDown={(e) => {
							if (e.key === 'Enter') fncShowTermsPop('termPii');
						}}>
						보기
					</button>
				</div>
